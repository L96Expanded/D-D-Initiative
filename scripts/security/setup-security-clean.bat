...
echo 2. Run: certbot certonly --standalone -d initiativetracker.ddns.net
...
echo 3. Test with: https://initiativetracker.ddns.net
...
echo.
echo echo Configuring Windows Firewall for initiativetracker.ddns.net
echo.
